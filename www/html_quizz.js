...
var quizz, quizz_far2eng, quizz_rand;
...
function start_quizz() {
  ...
  console.log("Quizz random: " + quizz_rand);
...
function special_capture_param(name, defaultValue) {
...
function next() {
  ...
  if (questionOrAnswer) {
    ...
    display = '<span class="question">' + currentQuestion + "</span>";
    display +=
      '<span class="answer">' + quizz.answer().join("<br/>") + "</span>";
  }
